...
global.tik = '-' // tiktok
global.tautanwa = 'https://wa.me/62895610059343'
global.wame = 'https://wa.me/62895610059343' // kalau gk punya bisa ganti pake gini wa.me/6285718828566

/*============== PAYMENT ==============*/
global.pdana = '0895610059343' //dana
global.povo = '-' //ovo
global.pgopay = '0895610059343' //gopay
global.plinkaja = '-' //link aja
global.ppulsa = '0895610059343' //telkomsel
global.ppulsa2 = '083160192605' // kalau ada kartu lain isi aja
global.psaweria = 'https://saweria.co/AraBotz'

/*============== NOMOR ==============*/
global.nomorbot = '6283160192605'
global.nomorown = '62895610059343'
global.nomorown1 = '62895610059343' //pake No Pacar lo Juga Boleh
global.namebot = 'ZeynBotz'
global.nameown = 'Zeyn Dev'
global.nameown1 = 'Zeyn Dev' //Pake Nama Pacar Lo Juga Boleh

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/dimas_farrel_a' // ig lo
global.sigpcr = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/' // ig cewek lo
/*============== Github Thanks To ==============*/
global.namagithub = 'Nama Github Belum Diisi' // nama github lu
global.linkgithub = 'Link Github Belum Diisi' // tarok link github lu

// klau kgk ada github kasih tanda '-' aja biar kgk error

/*============== STAFF ==============*/
global.owner = [
  ['62895610059343', 'Dimas', true],
  ['6283160192605', 'Zeyn botz', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.gcname = '™ ZeynBotz'//nama group kalian
global.readMore = readMore
global.wm = '                「 ZeynBotz 」'
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Zeyn MD ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ZeynBotz '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By ZeynBotz`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 ZeynDev  あ」'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["✘ 𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","⚠️ 𝘼𝙘𝙘𝙨𝙚𝙨 𝘿𝙖𝙣𝙞𝙚𝙙 ⚠️"])

/*============== STICKER WM ==============*/
global.stickpack = 'ZeynBotz'
global.stickauth = `By ©Zeyn`
 
/*============== LOGO ==============*/
global.fotonya1 = 'https://telegra.ph/file/2b16380197a08333517ba.jpg' 
global.fotonya2 = 'https://telegra.ph/file/2b16380197a08333517ba.jpg'
...
global.urlnya = "https://instagram.com/dimas_farrel_a"
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '0895-6100-59343'
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ JNGN DI UBAH ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
